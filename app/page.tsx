            ...
            >
              ...
              {state === "done" && gammaUrl && (
                ...
                >
                  ...
                  {/* Gamma embed — actual generated presentation */}
                  <div className="relative w-full rounded-2xl overflow-hidden border border-black/[0.07] dark:border-white/[0.07] shadow-[0_4px_24px_rgba(0,0,0,0.08)] dark:shadow-[0_8px_32px_rgba(0,0,0,0.4)]" style={{ aspectRatio: "16/9" }}>
                    <iframe
                      src={gammaUrl}
                  ...
                  <div className="flex justify-center pt-1">
                    <button
                      onClick={() => { setPrompt(""); setState("idle"); setGammaUrl(null); window.scrollTo({ top: 0, behavior: "smooth" }); }}
